...
public sealed class P05ProtectedIssueClosingKeywordGuardTests
{
    ...
    public void Ci_RejectsClosingKeywordsForProtectedP0IssueMetadata()
    {
        ...
        Assert.Contains("set -euo pipefail", metadataWorkflow, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("permissions: write-all", metadataWorkflow, StringComparison.OrdinalIgnoreCase);
