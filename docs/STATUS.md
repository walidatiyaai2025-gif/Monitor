...
## Programming closure hardening — PR #363

**Scope:** issues #362, #364, #365, #366 and #367.  
**Repository programming state:** implementation and regression coverage complete on the programming-closure branch; exact final closure still requires the docs-inclusive head to pass the repository-selected workflows.  
**Code-only Green evidence before canonical-doc reconciliation:** `98043db45f22ad8efa0817a204c1a05507e71c6d`; normal CI `32116997876` passed build, tests and release/P0 safety runtimes.  
