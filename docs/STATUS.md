...
**Repository cutover/evidence/finalization/session/release workflow:** COMPLETE through durable-release hardening PR #219 and selected-product-hash acceptance-session hardening PR #257; selected RC.61 durable publication remains pending manual dispatch under #162; locked-session gate/finalization chain-of-custody hardening is tracked under #258 / PR #259  
...
| P0.5 / #116 | ACTIVE | repository deployment/evidence/session/finalization/release-package/durable-promotion/workflow-supply-chain/native-Node-24/durable-release + selected-product-hash hardening complete; locked-session gate/finalization binding #258, selected RC.61 durable publication #162 and external IIS/HTTPS acceptance remain separately tracked |
...
- Issue #258 / PR #259: locked-session gate/finalization chain-of-custody hardening requires the externally preserved session-manifest SHA-256 before every gate PASS and throughout finalization/review. `Test-ProductionAcceptanceSessionBinding.ps1` validates the manifest lock/canonical paths, actual candidate ZIP/checksum and pack candidate/environment identity. Windows runtime now uses the real Session → Recorder → Finalizer → Validator chain with pack/manifest/candidate drift negatives. Exact final-head CI/Windows evidence is tracked on #258; this work cannot manufacture any real production PASS.
...
| P0-049 versioned artifact/checksum/evidence/release workflow | **REPOSITORY HARDENED** — RC.61 + reusable release pipeline + durable tag publication tooling + immutable session + selected-product-hash binding #256 + locked-session gate/finalization chain #258 + generator + recorder + finalizer + validator; exact existing-candidate promotion implementation merged, **actual RC.61 durable publication pending manual #162**; supply-chain pinning/removal hardening #168/#171 COMPLETE; native Node 24 Action migration #173/#174 COMPLETE; additional durable-release hardening through PR #219 COMPLETE |
...
**Overall:** 🟢 verified foundation · 🟢 P0.1–P0.4 COMPLETE · 🟢 P0.5 repository cutover/evidence/session/finalization/release/promotion/workflow-supply-chain/native-Node-24/durable-release hardening through PR #219 · 🟢 #256 selected-product-hash session hardening COMPLETE via PR #257 · 🟡 #258 locked-session gate/finalization chain-of-custody hardening tracked in repository · 🟢 BATCH-200 current-main reconciliation COMPLETE · 🟢 BATCH-700 50/50 COMPLETE and merged via PR #240 · 🟡 selected RC.61 durable publication pending manual #162 · 🟡 external IIS/HTTPS 15-gate acceptance pending · 🔴 production acceptance not yet granted
