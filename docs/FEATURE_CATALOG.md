...
| Selected-product-hash acceptance binding | P0.5 | Repository hardening | Issue #256; `New-ProductionAcceptanceSession.ps1` requires independent 64-hex `ExpectedProductSha256`, rejects a mutually consistent but substituted ZIP + checksum pair, rechecks the hash after copy, binds manifest/evidence to the selected hash, and keeps all 15 external gates fail-closed; exact PR/CI evidence is tracked on #256 |
