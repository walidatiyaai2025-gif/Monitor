...
| Native Node 24 GitHub Actions | P0.5 | In verification | Issue #173; migrate the immutable allowlist to official native Node 24 releases: checkout v7.0.1, setup-dotnet v6.0.0, upload-artifact v7.0.1, download-artifact v8.0.1; exact SHA + readable version comment locked by regression test; no release/promotion semantic or RC.61 change |
