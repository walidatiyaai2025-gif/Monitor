...
| RC.61 durable-promotion operator preflight | P0.5 | In verification | Issue #266 / PR #267; read-only preflight pins exact selected repository/run/artifact/digest/hash/source/tested-merge/tag, rejects provenance/expiry drift and emits exact promotion + separate verifier commands; it never dispatches or mutates release/tag state and cannot satisfy #162/#116/#111 |
