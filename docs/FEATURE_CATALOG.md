...
| First Production SingleNode release | P0.5 | Repository verified / external pending | Issue #116; complete immutable-session + IIS deployment + exact 15-gate evidence/finalization tooling; selected RC.53 on #116; actual trusted-HTTPS IIS/recycle/least-privilege/backup/rollback evidence still required |
...
| Immutable production acceptance session | P0.5 | Complete | Issue #150 / PR #151 merged 9a76abe61422502c4889b04ce8b6a59f18ac04f4; RC.53 candidate-bound workspace verifies exact ZIP/checksum, rejects reuse/unsafe/traversal paths and secret-like metadata, creates SHA-locked manifest + canonical 15-gate pack at 0/15; CI 31540968009 769/769, Real SQL 31540967997 8/8, Windows 31540968010 769/769 |
