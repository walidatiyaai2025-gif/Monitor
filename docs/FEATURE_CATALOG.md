...
| Server registration model | M1 | Local verified | Validated endpoint/auth metadata; in-memory repository |
| Connection secret boundary | M1 | Local verified | Opaque reference; values only from User Secrets/environment |
