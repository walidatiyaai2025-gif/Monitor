...
2. Run the merged read-only #266 preflight from a trusted authenticated operator checkout, then complete the manual exact-existing-candidate durable publication workflow on #162 and independently verify tag/assets/hash without rebuilding RC.61.
