...
| 2 | P0.2 | #113 | First real snapshot + truthful read-model mapping | ACTIVE / NEXT |
...
- P0.2 is active. The collector already gathers SQL Agent evidence, but the current `ServerCard` projection does not carry it into Server Details.
